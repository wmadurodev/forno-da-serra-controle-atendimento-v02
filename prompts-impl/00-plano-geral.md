...
| 3 | Execução do Fluxo de Atendimento — quadro Kanban (Tela 4) | Passos 1, 2 | **Em especificação** | `prompts-impl/passo-03-quadro-atendimento.md` |
...
- **Passo 3:** em especificação — prompt criado em `prompts-impl/passo-03-quadro-atendimento.md`, aguardando implementação e validação.
- **Passos 4 a 8:** aguardando finalização e validação do Passo 3 para serem especificados.
